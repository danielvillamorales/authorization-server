insert into client_app (client_id,client_secret,duration_in_minutes,required_proof_key) values ('client','$2a$10$7Odp.aajGwguh1EzszJzY.z4wosYxfSnLUqRdC5dYCItD4XxOKsVW',10,false);
...
insert into client_app (client_id,client_secret,duration_in_minutes,required_proof_key) values ('my-own-client','$2a$10$7Odp.aajGwguh1EzszJzY.z4wosYxfSnLUqRdC5dYCItD4XxOKsVW',10,true);
